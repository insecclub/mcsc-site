...
const share_message = `سلام! ياله ديت التيكي ديالي باش نحضر للكامب ديال السايبرسيكيورتي فالدورة 11.0، اللي منضمة من طرف "إنسيك إنسياس"، الكلوب ديال السايبرسيكيورتي فإنسياس. أش مازال كتسنى؟ بلا ما تحسب وقت، خدي التيكي ديالك وجي للكامب!
Hey, I got my ticket to attend the Moroccan Cybersecurity Camp v11.0 organized by INSEC ENSIAS, the cybersecurity club at ENSIAS. What are you waiting for? Don't hesitate, grab your ticket and join the camp!
@insec_ensias #mcsc2024`;
...
export const ShareActions = ({baseurl}:{baseurl:string}) => {
    ...
    const shareUrl = `${baseurl}/register/me/${user.login}`;
