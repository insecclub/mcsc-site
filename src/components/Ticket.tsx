...
const Ticket = ({username}:{username?:string}) => {
        ...
        return (
          <>
            {isMobile ? (
              ...
              <div className="shrink-0 mt-3 z-11  absolute top-12 pt-10 left-[38px] rounded-full">
                  <Image
                  src={user?.avatar_url}
                  width={57}
                  height={57}
              ...
              <div className="shrink-0 mt-4 relative pt-8">
                ...
                <div className="z-10 absolute bottom-20 right-0 pl-18 flex flex-col justify-center items-center">
